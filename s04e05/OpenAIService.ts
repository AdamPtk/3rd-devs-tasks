        ...
        messages: [
          {
            role: "user",
            content: [
              { type: "text", text: "Opisz ten screenshot. Zwróć uwagę na tekst i obrazy. Tekst jest w języku polskim. Umieść tekst w opisie. Jeśli nie ma tekstu, opisz obraz. Jeśli nie ma obrazków, podaj tylko tekst. Odpowiedz po polsku." },
