...
export class WebSearchService {
  ...
  constructor() {
    ...
    this.allowedDomains = [
      ...
      { name: 'Techcrunch', url: 'https://techcrunch.com/', scrappable: true },
      { name: 'Reuters', url: 'https://reuters.com/', scrappable: true },
      { name: 'SpaceX', url: 'https://www.spacex.com/', scrappable: true },
  ...
  async scrapeUrls(urls: string[], conversation_uuid: string): Promise<WebContent[]> {
    ...
    const scrappableUrls = urls.filter(url => {
      ...
      console.log('domain', domain);      const allowedDomain = this.allowedDomains.find(d => d.url === domain);
